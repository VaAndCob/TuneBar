...
///////////////////// VARIABLES ////////////////////
lv_anim_t * bounce_Animation( lv_obj_t *TargetObject, int delay);
...
//vaandcobBanner.png = (lv_img_dsc_t **)ui_imgset_;
//vaandcobBanner.png_size = sizeof(ui_imgset_)/(sizeof(lv_img_dsc_t*));
